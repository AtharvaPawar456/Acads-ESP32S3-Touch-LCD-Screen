...
void setup()
{
  ...
  // Get data for all sheet names
  String allTeacherData = getTeacherData("all"); // Assuming getTeacherData() function is defined elsewhere
...
void loop()
{
  ...
  // if (counter == 100) {
    ...
    // Access each sheet name one by one
      ...
      String teacherData = getTeacherData(sheetNames[sheetCounter].c_str());
